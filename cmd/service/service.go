...
var fs = flag.NewFlagSet("books", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		endpoint, err := zipkingo.NewEndpoint("books", "localhost:80")
		if err != nil {
			logger.Log("err", err)
			os.Exit(1)
		}
...
func getDBconn() *gorm.DB {
	...
	db.AutoMigrate(&repository.Books{})
...
func getRepository() repository.BooksRepository {
	return repository.NewBooksRepository()
}
